...
network_xml_location = os.path.join(PROJECT_PATH, 'xml', 'cerebellum', 'cerebellar_cortex.xml')
...
print "Simulated cerebellar cortex network for %f milliseconds" % args.time
