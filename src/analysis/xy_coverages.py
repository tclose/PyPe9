...
This module defines a function to calculate the coverages of the forests on xy plane
@author: Haozhe Zhang
"""
...
def xy_coverages(forest, VOX_SIZE, central_frac=(1.0, 1.0)):
        ...
        for z in range(mask._mask_array.shape[2]):
            ...
            flat_mask = np.sum(central_mask, axis=2) # the number of voxels covered by trees
...
#   load 8 differnt forests
    ...
    for i in range(8): # '8'here is the number of diferent forests
        VOX_SIZE=(0.5,0.5,1)
...
#        the forests of different ages have different colors
        if i== 0 or i == 1:
