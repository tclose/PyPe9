...
SCRIPT_NAME = 'single_molecular_loop'
# Required imports
import tombo
import argparse
...
parser.add_argument('--timestep', type=float, default=0.00025, help='The time step used for the simulation (default: %(default)s)')
parser.add_argument('--stim_seed', default=None, help='The seed passed to the stimulated spikes (defaults to time stamp)')
parser.add_argument('--np', type=int, default=4, help='The the number of processes to use for the simulation (default: %(default)s)')
...
parser.add_argument('--hoc', action="store_true", help="Run fabios original hoc model instead of the pyNN version")
