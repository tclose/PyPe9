...
void nest::music_event_in_proxy::Parameters_::set(const DictionaryDatum& d, State_& s)
{
  if (!s.registered_)
  {
...
void nest::music_event_in_proxy::State_::set(const DictionaryDatum&, const Parameters_&)
{}
...
void nest::music_event_in_proxy::init_node_(const Node& proto)
{
