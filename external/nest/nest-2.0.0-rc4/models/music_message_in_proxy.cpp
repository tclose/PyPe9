...
void nest::music_message_in_proxy::Parameters_::set(const DictionaryDatum& d, State_& s)
{
  if (!s.published_)
  {
...
void nest::music_message_in_proxy::State_::set(const DictionaryDatum&, const Parameters_&)
{}
