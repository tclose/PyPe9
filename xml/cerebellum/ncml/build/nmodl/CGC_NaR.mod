...
NEURON {
  RANGE NaR_h, NaR_m, comp3377_e, comp3377_gbar, comp3292_vcbdur, comp3292_vchdur, comp3292_vcsteps, comp3292_vcinc, comp3292_vcbase, comp3292_vchold
  RANGE i_NaR
  RANGE ina
  RANGE ena
...
DERIVATIVE states {
  ...
  v4161  =  NaR_hO 
NaR_hO'  =  
    -(NaR_hO * comp3377_beta_f(v)) + (1 - v4161) * (comp3377_alpha_f(v))
  v4164  =  NaR_mO 
NaR_mO'  =  
    -(NaR_mO * comp3377_beta_s(v)) + (1 - v4164) * (comp3377_alpha_s(v))
}
