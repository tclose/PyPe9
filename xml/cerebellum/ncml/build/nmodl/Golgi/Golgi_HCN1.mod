...
NEURON {
  RANGE comp269_vcbdur, comp269_vchdur, comp269_vcsteps, comp269_vcinc, comp269_vcbase, comp269_vchold, comp19_e, comp19_gbar, comp19_o_slow_plus_fast
  RANGE i_HCN1
  RANGE e
...
BREAKPOINT {
  ...
  i_HCN1  =  (comp19_gbar * comp19_o_slow_plus_fast) * (v - comp19_e)
  i  =  i_HCN1
}
